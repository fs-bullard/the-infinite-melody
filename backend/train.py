...
if __name__ == "__main__": 
    dataset = np.load("dataset2.npy", allow_pickle=True)[2500:]
    ...
    # create NN
    # note_model = MusicRNN(57, 57, n_timesteps, num_layers=2).to(device)
    ...
    # duration_model = MusicRNN(12, 12, n_timesteps, num_layers=2).to(device)
    ...
    for t in range(epochs):
        ...
        for X, y in loader:
            ...
            note_model.init_hidden(device)
            duration_model.init_hidden(device)
